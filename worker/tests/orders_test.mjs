...
// The app is given away to shop owners, and a single platform key means every storefront's
// Buy button pays the platform. Correct for the platform's own shop, wrong for everyone
// else's — their money, their chargebacks, someone else's account.
